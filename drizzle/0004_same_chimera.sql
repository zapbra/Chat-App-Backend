...
CREATE UNIQUE INDEX "thread_user_unique_idx" ON "dm_thread_participants" USING btree ("thread_id","user_id");--> statement-breakpoint
CREATE INDEX "user_id_idx" ON "dm_thread_participants" USING btree ("user_id");--> statement-breakpoint
